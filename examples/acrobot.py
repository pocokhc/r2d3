...
def create_parameter():
    ...
    kwargs = {
        ...
        "memory": PERRankBaseMemory(
            ...
            beta_steps=warmup+10_000,  # IS反映率の上昇step数
        ...
        "demo_ratio_steps": warmup+10_000,

        "episode_memory": PERProportionalMemory(1_000, alpha=0.8),
...
def run_rainbow(enable_train):
    ...
    run_gym_rainbow(enable_train, ENV_NAME, kwargs,
        nb_steps=kwargs["memory_warmup_size"] + 30_000,
        log_interval1=2000,
