...
from src.processor import CartPoleProcessor
...
def create_parameter():
    ...
    processor = CartPoleProcessor(enable_reward_step=False)
    ...
    kwargs = {
        ...
        "episode_memory": PERProportionalMemory(500, alpha=0.8),
        "episode_ratio": 1/64.0,
    }
...
def run_r2d3(enable_train):
    ...
    kwargs["gamma"] = 0.997
    kwargs["actor_model_sync_interval"] = 200  # learner から model を同期する間隔
